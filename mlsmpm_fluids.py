...
def initialize():
  for i in range(n_particles):
    if i < n_particles/2:
      x[i] = [ti.random() * 0.3 + 0.15, ti.random() * 0.3 + 0.05 ]
      material[i] = 0 # 0,1,2: fluid
    elif i < n_particles*3/4:
      x[i] = [ti.random() * 0.2 + 0.35 , ti.random() * 0.2 + 0.05 + 0.32]
      material[i] = 1
    else:
      x[i] = [ti.random() * 0.2 + 0.3 + 0.1*2, ti.random() * 0.2 + 0.05 + 0.54]
      material[i] = 2
    v[i] = ti.Matrix([0, 0])
