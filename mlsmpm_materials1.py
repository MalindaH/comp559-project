...
def initialize():
  for i in range(n_particles):
    if i < n_particles*5/6:
      x[i] = [ti.random() * 0.4 + 0.35, ti.random() * 0.4 + 0.05 ]
      material[i] = 0 # 0: fluid, 1: jelly, 2: snow
    elif i < n_particles *11/12:
      x[i] = [ti.random() * 0.15 + 0.3, ti.random() * 0.15 + 0.55]
      material[i] = 2
    else:
      x[i] = [ti.random() * 0.15 + 0.55, ti.random() * 0.15 + 0.7]
      material[i] = 2
    v[i] = ti.Matrix([0, 0])
